 ...
 */
class Add_Custom_Fields_To_Media_Loader {
	 ...
	 * @param     int    $priority       The shortcode execution priority order.
	 * @param     int    $accepted_args  How many arguments are accepted.
	 */
